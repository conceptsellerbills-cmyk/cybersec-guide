...
export const metadata: Metadata = { title: "Write for Us — CyberSec Guide", description: "Contribute a guest post to CyberSec Guide. Share your expertise on cybersecurity and privacy." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p className="page-subtitle">We welcome guest contributors who can bring original insights and expertise to our readers. If you know cybersecurity and privacy well, we'd love to publish your work.</p>
        <hr className="page-divider" />
        <h2>What We're Looking For</h2>
        <ul>
          <li>Original, well-researched articles on cybersecurity and privacy</li>
        ...
        <h2>How to Pitch</h2>
        <p>Email us at <a href="mailto:hello@cybersec-guide.com">hello@cybersec-guide.com</a> with the subject line "Guest Post Pitch" and include:</p>
        <ul>
