...
export const metadata: Metadata = { title: "Terms of Use — CyberSec Guide", description: "Terms of Use for CyberSec Guide (cybersec-guide.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p>By accessing and using cybersec-guide.com, you accept and agree to be bound by these Terms of Use. If you do not agree with any part of these terms, please do not use our website.</p>
        <h2>2. Use of Content</h2>
        <p>All content published on CyberSec Guide — including articles, reviews, images, and graphics — is the intellectual property of CyberSec Guide unless otherwise stated. You may not reproduce, distribute, or republish our content without prior written permission.</p>
        ...
        <p>CyberSec Guide is not liable for any direct, indirect, or consequential damages arising from your use of this website or reliance on information published here.</p>
        ...
        <h2>7. Contact</h2>
        <p>For questions about these Terms of Use, contact us at <a href="mailto:hello@cybersec-guide.com">hello@cybersec-guide.com</a>.</p>
      </div>
    </>
  );
}
