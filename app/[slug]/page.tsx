...
const CATEGORIES: { label: string; href: string }[] = [{"label":"🕵️ Ethical Hacking","href":"/category/ethical-hacking"},{"label":"🔒 Network Security","href":"/category/network-security"},{"label":"🛡️ Privacy Tools","href":"/category/privacy"},{"label":"🔑 Password & Auth","href":"/category/authentication"},{"label":"☁️ Cloud Security","href":"/category/cloud-security"},{"label":"📱 Mobile Security","href":"/category/mobile-security"},{"label":"💀 Ransomware","href":"/category/ransomware"},{"label":"📜 Certifications","href":"/category/certifications"},{"label":"🦠 Antivirus","href":"/category/antivirus"},{"label":"🐛 Bug Bounty","href":"/category/bug-bounty"},{"label":"🏢 Small Biz Security","href":"/category/small-business"},{"label":"🌑 Dark Web","href":"/category/dark-web"},{"label":"💻 Endpoint Security","href":"/category/endpoint-security"},{"label":"🎣 Phishing","href":"/category/phishing"},{"label":"📊 SIEM Tools","href":"/category/siem"},{"label":"🪪 IAM","href":"/category/iam"},{"label":"🔐 Zero Trust","href":"/category/zero-trust"},{"label":"🎯 Threat Intelligence","href":"/category/threat-intelligence"},{"label":"🔍 Vuln. Management","href":"/category/vulnerability-management"},{"label":"🚨 Incident Response","href":"/category/incident-response"},{"label":"⚙️ DevSecOps","href":"/category/devsecops"}];
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: post.description || "",
      type: "article",
      url: `https://www.cybersec-guide.com/${slug}`,
      siteName: "Cybersec Guide",
    ...
    alternates: { canonical: `https://www.cybersec-guide.com/${slug}` },
  };
}
...
export default async function ArticlePage({ params }: Props) {
  ...
  const schema = JSON.stringify({
    ...
    url: `https://www.cybersec-guide.com/${slug}`,
    mainEntityOfPage: { "@type": "WebPage", "@id": `https://www.cybersec-guide.com/${slug}` },
    author: { "@type": "Organization", name: "Cybersec Guide", url: "https://www.cybersec-guide.com" },
    publisher: {
      "@type": "Organization",
      name: "Cybersec Guide",
      url: "https://www.cybersec-guide.com",
      logo: { "@type": "ImageObject", url: "https://www.cybersec-guide.com/logo.png", width: 200, height: 60 }
    },
    keywords: post.keyword || "",
  });
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://www.cybersec-guide.com" },
      ...(post.category ? [{ "@type": "ListItem", position: 2, name: post.category.replace(/-/g, " ").replace(/\b\w/g, (l: string) => l.toUpperCase()), item: `https://www.cybersec-guide.com/category/${post.category}` }] : []),
      { "@type": "ListItem", position: post.category ? 3 : 2, name: post.title, item: `https://www.cybersec-guide.com/${slug}` },
    ],
  });
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        :root{--bg:#060a0f;--surface:#111520;--border:#1e2535;--text:#e4e8f4;--muted:#7a82a0;--accent:#22d3ee;--radius:10px}
          ...
          <article className="article">
            ...
            <div className="author-box">
              ...
              <div className="author-info">
                <div className="author-name">Cybersec Guide Editorial Team</div>
