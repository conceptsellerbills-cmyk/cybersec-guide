...
export const metadata: Metadata = {
  title: "All Articles — CyberSec Guide",
  description: "Browse every article published on CyberSec Guide.",
};
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .aa-card{background:#0c1018;border:1px solid #1e2535;border-radius:12px;overflow:hidden;display:flex;flex-direction:column;transition:border-color 0.15s,transform 0.15s}
