...
export const metadata: Metadata = { title: "Contact — CyberSec Guide", description: "Get in touch with the CyberSec Guide team." };
...
`}</style>
      <div className="page-wrap">
        ...
        <div className="info-card">
          ...
          <p>For faster responses, email us at <a href="mailto:hello@cybersec-guide.com">hello@cybersec-guide.com</a>. We reply within 1–2 business days.</p>
        </div>
