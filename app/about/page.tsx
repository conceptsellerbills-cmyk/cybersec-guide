...
export const metadata: Metadata = { title: "About — CyberSec Guide", description: "Learn about CyberSec Guide, our mission, and the team behind the site." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">About CyberSec Guide</h1>
        <p className="page-subtitle">We're a team of passionate writers and researchers dedicated to covering cybersecurity and privacy — helping our readers make smarter decisions with honest, in-depth content.</p>
        <hr className="page-divider" />
        <h2>Our Mission</h2>
        <p>CyberSec Guide was created with a single goal: to cut through the noise and give readers clear, trustworthy information about cybersecurity and privacy. We research, test, and compare so you don't have to.</p>
        <h2>What We Cover</h2>
        <p>We publish in-depth reviews, comparison guides, how-tos, and roundups on cybersecurity and privacy. Every article is written with accuracy and reader value in mind — no filler, no fluff.</p>
