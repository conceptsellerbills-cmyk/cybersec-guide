...
const SITE_NAME = "CyberSec Guide";

export const metadata: Metadata = {
  metadataBase: new URL("https://www.cybersec-guide.com"),
  title: { default: SITE_NAME, template: `%s | ${SITE_NAME}` },
  description: "Expert guides, reviews and tips.",
  alternates: {
    canonical: "/",
    types: {
      "application/rss+xml": [{ url: "/feed.xml", title: "Cybersec Guide RSS Feed" }],
    },
  },
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"WebSite","name":"Cybersec Guide","url":"https://www.cybersec-guide.com","potentialAction":{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://www.cybersec-guide.com/all-articles?q={search_term_string}"},"query-input":"required name=search_term_string"}}` }} />
        <style>{`
          .site-header{background:#060a0f;border-bottom:1px solid rgba(255,255,255,0.07);padding:14px 0;position:sticky;top:0;z-index:100}
          ...
          <div className="header-inner">
            <a href="/" className="site-brand">
              <svg className="site-logo" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#22d3ee" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" fill="#22d3ee18"/><path d="M9 12l2 2 4-4"/>
              </svg>
              {SITE_NAME}
            </a>
            <nav className="cat-nav" tabIndex={0}>
              ...
              <a href="/category/ethical-hacking">🕵️ Ethical Hacking</a>
              <a href="/category/network-security">🔒 Network Security</a>
              <a href="/category/privacy">🛡️ Privacy Tools</a>
              <a href="/category/authentication">🔑 Password & Auth</a>
              <a href="/category/cloud-security">☁️ Cloud Security</a>
              <a href="/category/mobile-security">📱 Mobile Security</a>
              <a href="/category/ransomware">💀 Ransomware</a>
              <a href="/category/certifications">📜 Certifications</a>
              <a href="/category/antivirus">🦠 Antivirus</a>
              <a href="/category/bug-bounty">🐛 Bug Bounty</a>
              <a href="/category/small-business">🏢 Small Business Security</a>
              <a href="/category/dark-web">🌑 Dark Web</a>
              <a href="/category/endpoint-security">💻 Endpoint Security</a>
              <a href="/category/phishing">🎣 Phishing Prevention</a>
              <a href="/category/siem">📊 SIEM Tools</a>
              <a href="/category/iam">🪪 IAM</a>
              <a href="/category/zero-trust">🔐 Zero Trust Security</a>
              <a href="/category/threat-intelligence">🎯 Threat Intelligence</a>
              <a href="/category/vulnerability-management">🔍 Vulnerability Management</a>
              <a href="/category/incident-response">🚨 Incident Response</a>
              <a href="/category/devsecops">⚙️ DevSecOps</a>
              </div>
            </nav>
          </div>
        </header>
          ...
          <div className="footer-inner">
            <div className="footer-grid">
              ...
              <div className="footer-col1">
                ...
                <p className="footer-desc">In-depth guides, reviews, and tutorials on cybersecurity tools, ethical hacking, privacy, and digital defense.</p>
            ...
            <div className="footer-bottom">
              <p className="footer-copy">© {new Date().getFullYear()} CyberSec Guide. All rights reserved.</p>
            </div>
          </div>
        </footer>
      
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-SVL38GYLDL"
