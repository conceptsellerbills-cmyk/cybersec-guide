...
export const metadata: Metadata = { title: "Cookie Policy — CyberSec Guide", description: "Cookie Policy for CyberSec Guide (cybersec-guide.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h2>Contact</h2>
        <p>If you have questions about our cookie use, contact us at <a href="mailto:hello@cybersec-guide.com">hello@cybersec-guide.com</a>.</p>
      </div>
    </>
  );
}
