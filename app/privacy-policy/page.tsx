...
export const metadata: Metadata = { title: "Privacy Policy — CyberSec Guide", description: "Privacy Policy for CyberSec Guide (cybersec-guide.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p>Welcome to CyberSec Guide ("we", "us", or "our"), accessible at cybersec-guide.com. This Privacy Policy explains how we collect, use, and protect your information when you visit our website.</p>
        ...
        <h2>6. Your Rights</h2>
        <p>You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at <a href="mailto:hello@cybersec-guide.com">hello@cybersec-guide.com</a>.</p>
        ...
        <h2>9. Contact</h2>
        <p>For privacy-related questions, contact us at <a href="mailto:hello@cybersec-guide.com">hello@cybersec-guide.com</a>.</p>
      </div>
    </>
  );
}
