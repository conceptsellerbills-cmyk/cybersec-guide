  ...
  return (
    <>
      ...
      <section className="hero">
        ...
        <div className="hero-badge">Security Intelligence</div>
        <h1 dangerouslySetInnerHTML={{ __html: "Master Cybersecurity<br />from Basics to Expert" }} />
        <p>In-depth guides, tool reviews and hands-on tutorials for ethical hacking, network defense and digital privacy. Stay secure in a hostile world.</p>
        <div className="hero-ctas">
          <a href="/getting-started" className="hero-cta-primary">Start Learning →</a>
          <a href="/categories" className="hero-cta-secondary">Browse Categories →</a>
        </div>
        <div className="stats-bar">
          {([{"v":"300+","l":"Guides Written"},{"v":"150+","l":"Tools Reviewed"},{"v":"50K+","l":"Monthly Readers"},{"v":"2025","l":"Current"}] as {v:string,l:string}[]).map((st) => (
      ...
      <div className="container">
        ...
        <section className="section" style={{ paddingBottom: 40 }}>
          ...
          <div className="trending-row">
            {([{"label":"Best VPNs 2025","hot":true,"href":"/best-vpns"},{"label":"Kali Linux Guide","href":"/kali-linux-guide"},{"label":"Password Managers","hot":true,"href":"/best-password-managers"},{"label":"Bug Bounty Guide","href":"/bug-bounty-beginners"},{"label":"Home Network Security","hot":true,"href":"/home-network-security"},{"label":"AI in Cybersecurity","href":"/ai-cybersecurity"}] as {label:string,hot?:boolean,href:string}[]).map((t) => (
        ...
        <section className="section" style={{ paddingTop: 20 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Essential Security Tools 2025</h2>
          </div>
          <div className="picks-grid">
            {([{"badge":"Best VPN","badgeType":"gold","icon":"🛡️","title":"Mullvad VPN","desc":"No logs, no email required, no-nonsense privacy. The gold standard for anonymity.","rating":5,"href":"/mullvad-vpn-review"},{"badge":"Best Password Mgr","badgeType":"silver","icon":"🔑","title":"Bitwarden","desc":"Open-source, audited, and free. The most trusted password manager for security-conscious users.","rating":5,"href":"/bitwarden-review"},{"badge":"Best for Learning","badgeType":"bronze","icon":"🕵️","title":"TryHackMe","desc":"The best platform to learn ethical hacking with guided labs and real-world scenarios.","rating":4,"href":"/tryhackme-review"}] as {badge:string,badgeType:string,icon:string,title:string,desc:string,rating:number,href:string}[]).map((p, i) => (
        ...
        <section className="section">
          ...
          <div className="section-header">
            <h2 className="section-title">How We Cover Cybersecurity</h2>
          </div>
          <div className="how-grid">
            {([{"num":"01","title":"We Test the Tools","desc":"Every security tool is tested in isolated lab environments by certified security professionals."},{"num":"02","title":"We Verify Claims","desc":"We audit privacy policies, read source code when available, and test no-log claims independently."},{"num":"03","title":"You Stay Secure","desc":"Clear, actionable guides help you implement real security without a computer science degree."}] as {num:string,title:string,desc:string}[]).map((h) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="category-grid">
            {([{"icon":"🕵️","label":"Ethical Hacking","desc":"Pentesting & vulnerability research","href":"/category/ethical-hacking"},{"icon":"🔒","label":"Network Security","desc":"Firewalls, IDS & defense","href":"/category/network-security"},{"icon":"🛡️","label":"Privacy Tools","desc":"VPNs, browsers & anonymity","href":"/category/privacy"},{"icon":"🔑","label":"Password & Auth","desc":"Password managers & MFA","href":"/category/authentication"},{"icon":"☁️","label":"Cloud Security","desc":"AWS, Azure & GCP hardening","href":"/category/cloud-security"},{"icon":"📱","label":"Mobile Security","desc":"Android & iOS security tips","href":"/category/mobile-security"},{"icon":"💀","label":"Ransomware Protection","desc":"Backup, defense & recovery","href":"/category/ransomware"},{"icon":"🏆","label":"Cybersecurity Certs","desc":"Security+, CISSP & OSCP","href":"/category/certifications"},{"icon":"🦠","label":"Antivirus & Anti-Malware","desc":"Bitdefender, Malwarebytes & more","href":"/category/antivirus"},{"icon":"🐛","label":"Bug Bounty","desc":"HackerOne, Bugcrowd & Intigriti","href":"/category/bug-bounty"},{"icon":"🏢","label":"SMB Security","desc":"Cybersecurity for small business","href":"/category/small-business"},{"icon":"🌑","label":"Dark Web Monitoring","desc":"Detect stolen data early","href":"/category/dark-web"},{"icon":"💻","label":"Endpoint Security","desc":"EDR, XDR & endpoint protection","href":"/category/endpoint-security"},{"icon":"🎣","label":"Phishing Prevention","desc":"Stop phishing & social engineering","href":"/category/phishing"},{"icon":"📊","label":"SIEM & Log Management","desc":"Splunk, Sentinel & Wazuh","href":"/category/siem"},{"icon":"🪪","label":"Identity & Access Mgmt","desc":"Okta, Entra ID & CyberArk","href":"/category/iam"},{"icon":"🚫","label":"Zero Trust Security","desc":"ZTNA architecture & implementation","href":"/category/zero-trust"},{"icon":"🔍","label":"Threat Intelligence","desc":"CTI tools, feeds & MITRE ATT&CK","href":"/category/threat-intelligence"},{"icon":"🔧","label":"Vulnerability Management","desc":"Nessus, Qualys & patch prioritization","href":"/category/vulnerability-management"},{"icon":"🚨","label":"Incident Response","desc":"IR plans, playbooks & DFIR tools","href":"/category/incident-response"},{"icon":"⚙️","label":"DevSecOps","desc":"SAST, DAST & secure CI/CD pipelines","href":"/category/devsecops"}] as {icon:string,label:string,desc:string,href:string}[]).map((c) => (
          ...
          <section className="section" style={{ paddingTop: 0 }}>
            ...
            <a href={`/${featured.slug}`} className="featured-card">
              ...
              <div className="featured-content">
                <span className="featured-badge">🔥 Top Guide</span>
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="section-header">
            <h2 className="section-title">Why Readers Trust CyberSec Guide</h2>
          </div>
          <div className="why-grid">
            {([{"icon":"🎓","title":"Certified Experts","desc":"Our writers hold OSCP, CEH and CISSP certifications — not just hobbyist enthusiasm."},{"icon":"🔬","title":"Lab-Tested","desc":"All tools are tested in real or isolated environments, never just reviewed from marketing pages."},{"icon":"🚫","title":"No Affiliate Bias","desc":"We recommend what actually works for security, not what pays the highest commission."},{"icon":"📅","title":"CVE Aware","desc":"We update guides when new vulnerabilities are discovered so your defenses stay current."}] as {icon:string,title:string,desc:string}[]).map((w) => (
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="faq-list">
            {([{"q":"Is it legal to learn ethical hacking?","a":"Yes — ethical hacking on systems you own or have explicit written permission to test is completely legal. Platforms like TryHackMe and HackTheBox provide legal practice environments."},{"q":"What VPN do you recommend for privacy?","a":"Mullvad and ProtonVPN are our top picks. Both have completed independent audits, have clear no-log policies, and don't require personal information to sign up."},{"q":"How do I start learning cybersecurity from scratch?","a":"Start with our Beginner's Roadmap — it covers networking fundamentals, Linux basics, and then moves into security concepts with free resources."},{"q":"Do I need to know coding to work in cybersecurity?","a":"Basic Python and Bash scripting help, but many cybersecurity roles (incident response, GRC, security analysis) don't require advanced programming skills."},{"q":"What certifications are worth getting in 2025?","a":"CompTIA Security+ for beginners, then OSCP for penetration testers or CISSP for senior security professionals. We have a detailed certification guide."}] as {q:string,a:string}[]).map((f) => (
        ...
        <div className="cta-section">
          ...
          <p>Step-by-step guides and honest tool reviews to help you build real digital security — no hype.</p>
          <a href="/getting-started" className="cta-btn">Explore All Security Guides →</a>
        </div>
