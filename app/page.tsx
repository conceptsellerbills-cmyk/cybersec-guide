...
export const metadata: Metadata = {
  ...
  description: "In-depth guides for ethical hacking, network security, privacy tools and digital defense. Learn to protect yourself and your systems.",
};
...
`}</style>
      ...
      <section className="hero">
        ...
        <a href="/getting-started" className="hero-cta">Start Learning →</a>
        <div className="stats-bar">
          {([{"v":"300+","l":"Guides Written"},{"v":"150+","l":"Tools Reviewed"},{"v":"50K+","l":"Monthly Readers"},{"v":"2025","l":"Current"}] as {v:string,l:string}[]).map((s) => (
      ...
      <div className="container">
        ...
        <div className="cta-section">
          <h2>Stay One Step Ahead of Threats</h2>
          <p>Get the latest cybersecurity guides, tool reviews and defensive strategies — updated for 2025.</p>
          <a href="/getting-started" className="cta-btn">Explore All Guides →</a>
        </div>
