...
export const metadata: Metadata = { title: "Advertise — CyberSec Guide", description: "Advertise with CyberSec Guide and reach a targeted audience interested in cybersecurity and privacy." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">Advertise on CyberSec Guide</h1>
        <p className="page-subtitle">Reach a highly engaged audience of readers actively researching and comparing cybersecurity and privacy. Our visitors are decision-ready — they come here to find the best options.</p>
        ...
        <h2>Get in Touch</h2>
        <p>For pricing, media kit, and availability, contact us at <a href="mailto:hello@cybersec-guide.com">hello@cybersec-guide.com</a> with the subject line "Advertising Inquiry". We'll respond within 2 business days.</p>
      </div>
    </>
  );
}
